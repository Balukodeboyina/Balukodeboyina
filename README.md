<h1 align="center">Hi 👋, I'm Balu Kodeboyina</h1>

<h3 align="center">
Aspiring Software Engineer • AI Workflow Automation • AI Agents Developer
</h3>

<p align="center">
Building intelligent AI-powered applications using LangChain, RAG Systems, Java, and Python.
</p>

<p align="center">
  <a href="https://github.com/Balukodeboyina">
    <img src="https://komarev.com/ghpvc/?username=Balukodeboyina&label=Profile%20Views&color=0e75b6&style=flat" alt="profile views" />
  </a>
</p>
...
- 🎓 B.Tech CSE Student (UG'28)
- 🤖 Passionate about AI Workflow Automation & AI Agents
- 🧠 Exploring LangChain, LangGraph, RAG Architectures & LLM Applications
- 💻 Strong interest in Software Engineering, Backend Development & Open Source
- 🌱 Currently learning Advanced AI Infrastructure & Cloud Technologies
- ⚡ Building real-world AI-powered applications with modern tools
...
An intelligent academic assistant powered by RAG architecture and semantic search.

### ✨ Features
- AI-powered Q&A system
- Semantic search using FAISS
- PDF document analysis
- Quiz generation & study planning
- Performance analytics
- Real-time reminders

### 🛠️ Tech Stack
`Python` `LangChain` `FAISS` `PyTorch` `Streamlit` `PostgreSQL` `Llama 3.3`

---

## 🤖 AI Workflow Automation System

Built intelligent AI workflows integrating automation pipelines and task orchestration.

### 🛠️ Tech Stack
`Python` `APIs` `Automation Tools`
...
- ✅ Cisco Certified: Operating System Basics
- ✅ HackerRank 5⭐ in C Programming
